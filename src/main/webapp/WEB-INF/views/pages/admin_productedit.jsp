				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-warning">
							...
							<div class="box-body">
								<form role="form"
									action="${pageContext.request.contextPath}/admin/product/edit" enctype="multipart/form-data"
									method="post">
									<!-- text input -->
									<div class="form-group">
										<label>Id</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${product.id}" name="id">
									</div>

									<div class="form-group">
										<label>Name</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${product.name}"
											name="name">
									</div>
									...
									<div class="form-group">
										...
										<textarea class="form-control" rows="3"
											placeholder="Enter ..." name="description">${product.description}</textarea>
									</div>

									<div class="form-group">
										<label for="exampleInputFile">File Image</label> <input
											type="file" id="inputfile" name="file">
									</div>

									<div class="form-group">
										<label>Price</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${product.price}" name="price">
									</div>
									
									<div class="form-group">
										<label>Quantity</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${product.quantity}" name="quantity">
									</div>
									<div class="form-group">
										<label>Discount</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${product.discount}" name="discount">
									</div>
									...
									<!-- select -->
									<div class="form-group">
										<label>Producttype</label> <select class="form-control"
											name="producttype">
