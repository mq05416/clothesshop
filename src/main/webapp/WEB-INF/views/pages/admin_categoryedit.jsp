				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-warning">
							...
							<div class="box-body">
								<form role="form"
									action="${pageContext.request.contextPath}/admin/category/edit?${_csrf.parameterName}=${_csrf.token}"
									method="post">
									<!-- text input -->
									<div class="form-group">
										<label>Id</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${producttype.id}" name="id">
									</div>

									<div class="form-group">
										<label>Name</label> <input type="text" class="form-control"
											placeholder="Enter ..." value="${producttype.name}"
											name="name">
									</div>
									...
									<div class="form-group">
										...
										<textarea class="form-control" rows="3"
											placeholder="Enter ..." name="description">${producttype.description}</textarea>
									</div>
